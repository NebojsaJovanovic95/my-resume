...
- Coordinated handover and managed systems on large scale potash project - Jansen
...
- Delivered a **computer vision solution** for **Onaping Depth Mine**, using **Python (Flask, PyTorch)** and **Angular** to enhance safety and operational efficiency.  
- Designed and deployed an **edge computing system** for field-level monitoring and ML model execution.  
- Collaborated with multidisciplinary teams to modernize legacy tools and automate data workflows.  
- Applied **Azure ML** and **Azure DevOps** to streamline experimentation, deployment, and monitoring processes.  
- Developed and tested personal software tools, including a **custom web framework** and **in-memory database** for R&D use.
- Package engineering work on several Lithium and Copper processing projects - Lilac, Licycle, Manjar Maju Rafinery, etc.
- Tunnel Fire Ventilation Design on La Fontayne Tunnel and other.
---


## Projects
Jansen Commissioning - On site work as Handover coordinator within HBJV Commissioning team
  - prepared Handover Packages
  - prepared Subsystem Test Packages
  - Notices of Energization - Worked in optimizing flows in Document systems, like automatically generating NOE documents
  - Leveraged Systems Tools like Smart Plant Foundation, Smart Completion and Sharepoint to manage project documents, enable contractors and expedite execution
**Energy Plant Optimization Tool - VISTA (Hatch)**
  – Implemented modules for data ingestion and performance analysis in C++
  - Maintained legacy C++ engine and C# UI components
...
---
## Interests
Large Project Execution, Site Work, Applied AI in industry, control systems, energy technologies, and embedded software.
